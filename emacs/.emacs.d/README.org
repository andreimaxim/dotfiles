...
configuration file is also the documentation of the code. 
...
Use the crux package to define some useful shortcuts:
...
on big screens but it's extremely legible on a regular laptop screen.
